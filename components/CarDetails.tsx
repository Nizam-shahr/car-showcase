        ...
        >
           ...
           <div className="fixed inset-0 overflow-y-auto">
            ...
            >
                ...
                rounded-2xl bg-white text-left p-6 shadow-xl 
                transition-all flex flex-col gap-5'>
                    <button
                    type='button'
                    onClick={closeModal}
                    className="absolute top-0 right-0.5 z-10 w-fit 
                ...
                fill priority className="object-contain" />
                        ...
                        <div className="flex gap-3">
                            ...
                            rounded-lg">
                                 <Image src={carImageUrl(car,'29')} alt='car model'
                fill priority className="object-contain" />
                            </div>
                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 
                            rounded-lg">
                                 <Image src={carImageUrl(car,'33')} alt='car model'
                fill priority className="object-contain" />
                            </div>
                            <div className="flex-1 relative w-full h-24 bg-primary-blue-100 
                            rounded-lg">
                                 <Image src={carImageUrl(car,'13')} alt='car model'
                fill priority className="object-contain" />
                            </div>
                        </div>
                    </div>
